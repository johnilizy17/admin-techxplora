...
import { IconUsersGroup, IconUserCheck, IconUserX, IconQuestionMark, IconHomeQuestion, IconMapQuestion, IconMarkdownOff } from "@tabler/icons-react";
  ...
  const groupStats = [
    {
      title: "Total Quiz",
      value: 68,
      icon: <IconHomeQuestion className="w-8 h-8 text-blue-500" />,
      color: "border-blue-500/30 hover:border-blue-500/50",
    },
    {
      title: "Active Quiz",
      value: 54,
      icon: <IconMarkdownOff className="w-8 h-8 text-green-500" />,
      color: "border-green-500/30 hover:border-green-500/50",
    },
    {
      title: "Inactive Quiz",
      value: 14,
      icon: <IconMapQuestion className="w-8 h-8 text-red-500" />,
